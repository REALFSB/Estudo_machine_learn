...
# Avaliando o modelo
print("R^2 treinamento:", regressor_rna_casa.score(x_casas_treinamento_scaled, y_casas_treinamento_scaled))
print("R^2 teste:", regressor_rna_casa.score(x_casas_teste_scaled, y_casas_teste_scaled))

# Fazendo previsões no conjunto de teste
previsoes_scaled = regressor_rna_casa.predict(x_casas_teste_scaled)
